# Generated by Django 2.2 on 2020-09-29 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('F', 'формируется'), ('P', 'оплачен'), ('R', 'готов к выдаче'), ('C', 'отменен')], default='F', max_length=1, verbose_name='статус')),
